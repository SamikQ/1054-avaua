...
function renderIndicators() {
  const indicatorsContainer = document.querySelector(
    ".best-deals__carousel-indicators"
  );
  indicatorsContainer.innerHTML = "";
  for (let i = 0; i < slides.length; i++) {
    indicatorsContainer.innerHTML += `<button class="best-deals__carousel-indicator ${
      i === currentSlide ? "best-deals__carousel-indicator--active" : ""
    }"></button>`;
  }
  const indicators = document.querySelectorAll(
    ".best-deals__carousel-indicator"
  );
